        ...
        <div className="info-main-card">
          ...
          <div className="info-grid">
            ...
            <div className="info-card">
              ...
              <p>
                В одной заявке можно приобрести любые материалы, отображаются материалы того проекта, в котором <strong>вы СЕЙЧАС находитесь</strong> количество материалов в одной заявке <strong>НЕОГРАНИЧЕННО</strong>
              </p>
            </div>
