...
export default function QuestionMatching({ question, value = {}, onChange, disabled }: Props) {
  ...
  // 3. Слежение за размерами (ResizeObserver) для точности линий
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Отрисовка линии, которую тянет пользователь */}
