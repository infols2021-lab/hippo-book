...
export function HeroView({ data }: { data: HeroBlock["data"] }) {
  return (
    <div style={{
      ...
      {data.subtitle && (
        <p style={{
          fontSize: "17px", color: "rgba(255,255,255,0.8)", maxWidth: "540px",
          margin: "0 auto 32px", fontWeight: 400, lineHeight: 1.6,
        }}>
          {data.subtitle}
        </p>
      )}
...
export function TextSectionView({ data }: { data: TextSectionBlock["data"] }) {
  return (
    <div style={{ marginTop: "48px", marginBottom: "24px" }}>
      ...
      {data.title && (
        <h2 style={{
          fontSize: "clamp(22px, 3.5vw, 30px)", fontWeight: 900, color: "#111827",
