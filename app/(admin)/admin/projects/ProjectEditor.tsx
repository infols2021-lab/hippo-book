    ...
    <div style={previewStyles}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <div>
            ...
            <div style={{ fontSize: "12px", color: "color-mix(in srgb, var(--project-text) 60%, transparent)", fontWeight: 600 }}>
              Профиль ученика
            </div>
          </div>
        </div>
        <div style={{ display: "flex", gap: "8px" }}>
          <div style={{ padding: "8px 16px", borderRadius: "12px", background: "color-mix(in srgb, var(--project-text) 5%, transparent)", color: "var(--project-text)", fontWeight: 700, fontSize: "12px", border: "1px solid var(--glass-border)" }}>
            Меню
          </div>
          <div style={{ padding: "8px 16px", borderRadius: "12px", background: "color-mix(in srgb, #ef4444 10%, transparent)", color: "#ef4444", fontWeight: 700, fontSize: "12px" }}>
            Выйти
          </div>
        </div>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: "20px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          >
            <div style={{ fontSize: "13px", fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.05em", color: "color-mix(in srgb, var(--project-text) 60%, transparent)", marginBottom: "16px" }}>
              Статистика
            </div>
